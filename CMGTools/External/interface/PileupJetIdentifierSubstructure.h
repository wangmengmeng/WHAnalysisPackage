...
/*// add tau4/tau5 etc
        DECLARE_VARIABLE(tau5        ,float);
        DECLARE_VARIABLE(tau3tau1    ,float);
        DECLARE_VARIABLE(tau4tau1    ,float);
        DECLARE_VARIABLE(tau5tau1    ,float);
        DECLARE_VARIABLE(tau3tau2    ,float);
        DECLARE_VARIABLE(tau4tau2    ,float);
        DECLARE_VARIABLE(tau5tau2    ,float);
        DECLARE_VARIABLE(tau4tau3    ,float);
        DECLARE_VARIABLE(tau5tau3    ,float);
        DECLARE_VARIABLE(tau5tau4    ,float);
*/
};
